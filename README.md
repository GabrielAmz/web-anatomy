...
- **Teardowns (8)** — full-page audits: `landing-page-teardown`, `pricing-page-teardown`, `comparator-teardown`, `persona-teardown`, `signup-flow-teardown`, ...
- **Section revamps (9)** — single-section deep cuts: `hero-revamp`, `pricing-table-revamp`, `feature-grid-revamp`, `faq-revamp`, `comparison-table-revamp`, ...
- **Page generation (4)** — dedicated builders: `create-page`, `comparator-page`, `pricing-page`, `use-case-page`
