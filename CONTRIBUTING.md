...
- **New skills** — benchmark workflows, page-level audits, section revamps, page generators, strategic plays
...
4. **Write the body** — under ~5000 tokens / 500 lines. Push detail into `references/<topic>.md`. Body structure:
   ...
   - Step 1 — load `.agents/webanatomy-context.md` or run `webanatomy-setup`
   - Step 2+ — the framework
   - Anti-patterns to flag
   - **Reference patterns** — benchmark-backed examples where available, or at least one named real-world company with a URL
   - Output format spec
...
- No generic best-practice prose. Every recommendation needs benchmark evidence, a named company, or a specific number behind it.
