...
Connecting the hosted Web Anatomy MCP for live benchmark data is optional — sign in at https://webanatomy.ai/mcp-install to get your token + per-IDE config. The skills run fully without it.
